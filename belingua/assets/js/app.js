...
// edit-order
// $("#date-end-edit-order").on('click', function () {
...
$("#date-start-edit-order").parent().css("z-index", "9999");
$("#date-end-edit-order").parent().css("z-index", "9999");

$("#date-start-edit-order").datepicker({
	dateFormat: "d M yy",
	minDate: minDate,
	/*onClose: function(selectedDate){
		$('#form-step__date_start1').datepicker("option", "minDate", selectedDate)
...
$("#date-end-edit-order").datepicker({
	dateFormat: "d M yy",
	minDate: minDate,
});

// $("#date-end-edit-order11").parent().css('z-index','9999');

// $("#date-end-edit-order11").datepicker({
// 	dateFormat: "d M yy",
// 	minDate: minDate,
// });
...
$("#form-step__work_time1").on("keyup", function () {
	...
	if (timing < 3) {
		...
		$("#form-step__price_end1").val(priceFrom);
...
function calculatePrice(translateType) {
	...
	if (translateType === "Знаков") {
		$("#form-step__price_start1").val(
			Math.round((minPricePerList / 1800) * numbers)
		);
	}
	...
	if (translateType === "Минут") {
		$("#form-step__price_start1").val(
			Math.round((minPricePerHour / 60) * numbers)
		);
	}
...
$("#form-step__price_end1").on("blur", function () {
	...
	var priceStart = $("#form-step__price_start1").val();
